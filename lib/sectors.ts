...
export const SECTORS: Sector[] = [
  /* ------------------------------------------------------------------ 99 */
  {
    ...
    imageAlt: "Residential apartment blocks in Noida",
  ...
  /* ----------------------------------------------------------------- 105 */
  {
    ...
    credit: "Pankaj Kumar",
    bandCaption: "The kothi belt — plotted land, independent houses, very little new supply.",
  ...
  /* ----------------------------------------------------------------- 130 */
  {
    ...
    imageAlt: "High-rise residential towers beside a wide road in Noida",
  ...
  /* ----------------------------------------------------------------- 141 */
  {
    ...
    imageAlt: "Residential buildings and open ground in Noida",
  ...
  /* ----------------------------------------------------------------- 151 */
  {
    ...
    imageAlt: "Open land and new development on the edge of Noida",
    credit: "Nitesh Solanky",
    bandCaption: "The new frontier — farm plots and launches at the far end of the Expressway.",
